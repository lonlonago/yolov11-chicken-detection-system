# YOLOv11 chicken detection system

## Body

YOLOv11 Chicken Detection System Based on Deep Learning YOLOv11: (YOLOv11+YOLO dataset + UI interface + login and registration interface + Python project source code + model)

nc: 1 class,
Name: ['rooster'],
Dataset quantity: training set 128 images, validation set 38 images, test set 19 images.
